...
def parse(args, model_epoch=None):
    ...
    if opt['phase'] == 'train':
        experiments_root = os.path.join(
            'experiments', '{}_{}_{}_{}'.format(opt['name'], opt['datasets']['train']['l_resolution'],
                                                opt['datasets']['train']['r_resolution'],
                                                opt['model']['beta_schedule']['train']['n_timestep']))
    elif opt['phase'] == 'test':
        experiments_root = os.path.join(
            'experiments', '{}_{}_{}_{}_{}'.format(opt['name'], opt['datasets']['test']['l_resolution'],
                                                   opt['datasets']['test']['r_resolution'],
                                                   opt['model']['beta_schedule']['test']['n_timestep'], model_epoch))
